...
--
--  11. QUIÉN CAMBIÓ QUÉ TEXTO, Y QUÉ DECÍA ANTES. Nuevo el 2026-09-16, al
--     final del todo. Una columna en textos_panel -original- y la función
--     de la bitácora, que ahora apunta la clave del texto y lo que decía
--     antes. Sin correrlo el editor funciona igual; solo que Trazabilidad
--     no dice qué texto era. Es supabase-textos-rastro.sql entero.
--
--  12. LA REVISIÓN DE LOS DOCUMENTOS. Nuevo el 2026-09-16, al final del
--     todo. Una columna en documentos -revisado_en, cuándo se revisó- y un
--     disparador que apunta en la bitácora quién validó o rechazó cada
--     papel. Sin correrlo la bandeja funciona igual; solo que no se guarda
...
-- ═══════════════════════════════════════════════════════════════════════
--  11. QUIÉN CAMBIÓ QUÉ TEXTO, Y QUÉ DECÍA ANTES · 2026-09-16
-- ═══════════════════════════════════════════════════════════════════════
--  Lo mismo que supabase-textos-rastro.sql, sin su cabecera: el porqué
--  está allí. Se puede correr más de una vez.
...
-- ═══════════════════════════════════════════════════════════════════════
--  12. LA REVISIÓN DE LOS DOCUMENTOS · 2026-09-16
-- ═══════════════════════════════════════════════════════════════════════
--  Lo mismo que supabase-revision-papeles.sql, sin su cabecera: el porqué
--  está allí. Se puede correr más de una vez.
