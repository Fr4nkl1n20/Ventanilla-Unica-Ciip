...
| `PROBAR-PANEL.bat` | Lanzar las 863 pruebas del panel y las 5 comprobaciones de las claves de traducción |
...
**El panel** (863 pruebas, `PROBAR-PANEL.bat`): los contadores del camino y de
