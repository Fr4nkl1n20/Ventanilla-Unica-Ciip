...
| `PROBAR-PANEL.bat` | Lanzar las 705 pruebas del panel y las 5 comprobaciones de las claves de traducción |
...
**El panel** (705 pruebas, `PROBAR-PANEL.bat`): los contadores del camino y de
